    ...
    <main>
      <section className="pizza-panic">
        ...
        <p className="pizza-panic__summary">
          ...
          International Animation Festival. The film tells the story of a
          botched demon summoning and the ensuing hijinks. As design supervisor,
          I was responsible for keeping the production and style of the fun-pack
          on track and ready for film production. I and ten other students were
